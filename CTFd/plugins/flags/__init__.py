...
class CTFdAllFlag(BaseFlag):
    name = "all"
    templates = {  # Nunjucks templates used for key editing & viewing
        "create": "/plugins/flags/assets/all/create.html",
        "update": "/plugins/flags/assets/all/edit.html",
    }
...
FLAG_CLASSES = {"static": CTFdStaticFlag, "regex": CTFdRegexFlag, "all": CTFdAllFlag}
